...
# Cleaning up the graph
  ...
  theme_void() + 
    ...
    labs(title = "Anisa Dhana's layout for COVID-19 Confirmed Cases in the US 9/26/20") +
    theme(
...
ggplot(data = us, mapping = aes(x = long, y = lat, group = group)) + 
  ...
  ggtitle("Number of Confirmed Cases by US County 9/26/20") +
  theme_bw() 
```
...
## References
Application written in R [@RCoreTeam] using data from the COVID-19 Dashboard by Johns Hopkins University (JHU)[@JHUCSSE].